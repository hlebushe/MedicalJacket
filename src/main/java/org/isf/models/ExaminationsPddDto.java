...
public class ExaminationsPddDto {
    ...
    public ExaminationsPddDto(Examinations examination) {
    ...
    public ExaminationsPddDto(PatientMeasurements patientMeasurements) {
